#############################################################################
##
##  PackageInfo.g for the package `Ferret'               Christopher Jefferson
##
...
##  one line.
Subtitle := "Exponential Searching of groups",
...
##  <!ENTITY RELEASEDATE "01 February 2014">
##  <!ENTITY RELEASEYEAR "2014">
##  <#/GAPDoc>

PackageWWWHome :=
  Concatenation( "http://www.cs.st-andrews.ac.uk/~caj/",
...
# utilities.",
AbstractHTML :=
  "The <span class=\"pkgname\">ferret</span> package, collects a number \
   of algorithms for solving search problems. It can solve, among other \
   problems, finding minimal and canonical images and stabilizer of many \
   types of objects in groups and cosets.",
...
PackageDoc := rec(
  ...
  LongTitle := "Exponential Search Group Algorithms",
),
...
Dependencies := rec(
  ...
  # in ferretion are called (or global lists or records are accessed)
...
Keywords := ["minimal image", "intersection", "search", "stabilizer"]
