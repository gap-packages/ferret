...
gap> Stabilizer(SymmetricGroup(5), [1,2,3], OnSets) = Group([ (2,3), (1,2), (4,5) ]);
#I  Considering ferret for Stabilizer
#I  Using ferret for Stabilizer(.., OnSets)
true
gap> Stabilizer(SymmetricGroup(5), [[1,2,3],[2,3,4]], OnSetsSets) = Group([(1,4),(2,3)]);
#I  Considering ferret for Stabilizer
#I  Using ferret
true
gap> Stabilizer(SymmetricGroup(5), [[1,],[2,3],[4]], OnSetsDisjointSets) = Group([(1,4),(2,3)]);
#I  Considering ferret for Stabilizer
#I  Using ferret for Stabilizer(.., OnSetsDisjointSets)
true
gap> Stabilizer(SymmetricGroup(5), [[1,],[2,3],[4]], OnTuplesSets) = Group([(2,3)]);
#I  Considering ferret for Stabilizer
#I  Using ferret for Stabilizer(.., OnTuplesSets)
true
gap> Stabilizer(SymmetricGroup(5), [1,2,3], OnTuples) = Group([(4,5)]);
#I  Considering ferret for Stabilizer
true
gap> Stabilizer(SymmetricGroup(5), [[1,2],[3]], OnTuplesTuples) = Group([(4,5)]);
#I  Considering ferret for Stabilizer
#I  Considering ferret for Stabilizer
true
